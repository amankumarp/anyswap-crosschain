  ...
  return (
    ...
    <>
      ...
      <p>
        ...
        This Privacy Policy document contains types of information that is collected and recorded by Xtring and how we
        use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in Xtring. This policy is not applicable to any information
      ...
      <h2 className="heading">Log Files</h2>

      <p>
        Xtring follows a standard procedure of using log files. These files log visitors when they visit websites. All
      ...
      <h2 className="heading">Cookies and Web Beacons</h2>

      <p>
        Like any other website, Xtring uses &apos;cookies&apos;. These cookies are used to store information including
      ...
      <h2 className="heading">Advertising Partners Privacy Policies</h2>

      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Xtring.</p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Xtring, which are sent directly to users&apos; browser.
      ...
      <p>Note that Xtring has no access to or control over these cookies that are used by third-party advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>
        Xtring&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
      ...
      <h2 className="heading">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
      ...
      <h2 className="heading">GDPR Data Protection Rights</h2>
      ...
      <h2 className="heading">Children&apos;s Information</h2>
      ...
      <p>
        Xtring does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
