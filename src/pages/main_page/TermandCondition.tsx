  ...
  return (
    <>
      <Term>
        ...
        <p>
          These terms and conditions outline the rules and regulations for the use of https://xtring.network/&apos;s
          Website, located at https://xtring.network/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Xtring if
        ...
        <p>
          We employ the use of cookies. By accessing Xtring, you agreed to use cookies in agreement with the
          https://xtring.network/&apos;s Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, https://xtring.network/ and/or its licensors own the intellectual property rights for
          all material on Xtring. All intellectual property rights are reserved. You may access this from Xtring for
          your own personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Xtring</li>
          <li>Sell, rent or sub-license material from Xtring</li>
          <li>Reproduce, duplicate or copy material from Xtring</li>
          <li>Redistribute content from Xtring</li>
        </ul>


        <p>
          Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. https://xtring.network/ does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and opinions of https://xtring.network/,its agents
          and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, https://xtring.network/ shall not be liable for the Comments or for
          any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or
          appearance of the Comments on this website.
        </p>

        <p>
          https://xtring.network/ reserves the right to monitor all Comments and to remove any Comments which can be
        ...
        <p>
          You hereby grant https://xtring.network/ a non-exclusive license to use, reproduce, edit and authorize others
        ...
        <p>
          ...
          https://xtring.network/; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to https://xtring.network/. Please include your name, your
        ...
        <p>
          No use of https://xtring.network/&apos;s logo or other artwork will be allowed for linking absent a trademark
          license agreement.
        </p>
