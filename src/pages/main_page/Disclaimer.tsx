    ...
    <>
      <Disclaim>
        ...
        <p>
          ...
          to contact us by email at support@xtring.network .
        </p>

        <h2>Disclaimers for Xtring</h2>

        <p>
          All the information on this website - https://xtring.network/ - is published in good faith and for general
          information purpose only. Xtring does not make any warranties about the completeness, reliability and accuracy
          of this information. Any action you take upon the information you find on this website (Xtring), is strictly
          at your own risk. Xtring will not be liable for any losses and/or damages in connection with the use of our
          website.
        </p>
